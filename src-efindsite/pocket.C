...
{
 double d_weights_lr[7]  = { -8.26665041, 1.182144, 0.377906, 0.775673, 1.891657, 2.956348, 1.247619 };
 double d_weights_lda[7] = { -4.55744635, 0.838787, 0.187473, 0.115758, 0.946232, 2.753960, 0.699665 };
